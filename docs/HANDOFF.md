...
> `tsc`/`eslint`/`build` clean, E2E **23/23**, CI green. **33 issues open. NEXT when asked:
> Group F — infrastructure and tooling** (#30, #111 — read its round-3-flagging-round-2 warning
> first — #40, #34, #35, #112, #32, #107). After F: **G**/**H** as filler.
>
