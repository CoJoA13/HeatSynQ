...
> eight of #61–#64, #59, #60, #89, #96 on branch `group-a-invoice-engine`, gates **3095 tests / 182
> files**, `tsc`/`eslint`/`build` clean; what the fixes actually did, where they exceeded the issues,
> is in §6. **55 open. NEXT: B** —
