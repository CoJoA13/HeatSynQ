...
> DONE (2026-08-17)** — Group A merged as `1c1fc77` (PR #133), and **Group B (A/R) is complete on
> branch `group-b-ar`**. **NEXT: Group C** (shipping/status; #65 is the real one — voiding a reversal
> drives net shipped quantities negative). Task 0's detail: **#6**, **#10** and **#7** were re-verified against the code and closed with their
