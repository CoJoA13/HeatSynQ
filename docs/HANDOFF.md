...
> DONE (2026-08-17)** — Group A merged as `1c1fc77` (PR #133), Group B as `6bc45ea` (PR #135).
> **THE OWNER IS HOLDING HERE. Group C is next when asked, not before** (shipping/status; #65 is the
> real one — voiding a reversal drives net shipped quantities negative). Task 0's detail: **#6**, **#10** and **#7** were re-verified against the code and closed with their
...
> process (~15–20), spec §15. **Group C is MERGED — `4cada64` (PR #141, squash, 2026-08-18)**:
> all eight (#65, #52, #42, #41, #44, #45, #46, #51), two kickoff rulings + two mid-flight
> rulings in spec §15, four migrations, three task reviews ALL Approved on round 1, then FIVE
> Codex rounds (nine findings, all fixed on-branch — see the header). Gates on main: 3166 tests /
> 184 files, E2E 23/23, CI green. **42 issues open. Next when asked: Group E**, which carries
> #73, #80, #139 and #140 alongside its own five (#88 is ruled — build the broken-chain flag).
>
